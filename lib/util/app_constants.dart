...
class AppConstants {
  static const String appName = 'Masa Food';
  static const double appVersion = 2.5;

  static const String fontFamily = 'Roboto';
  static const bool payInWevView = false;
  static const int balanceInputLen = 10;
  static const String webHostedUrl = 'https://masafood.gr';
  ...
  static List<LanguageModel> languages = [
    LanguageModel(imageUrl: Images.greek, languageName: 'Ελληνικά', countryCode: 'EL', languageCode: 'el'),
